...
**SREDNJE (3):** PF-1 (prva rima na sporoj vezi 7,1 s – rečnik po kantama, veći zahvat) · PF-3 (`app.js` neminifikovan – traži build korak u Dockerfile-u, nije rađeno bez lokalne probe Dockera) · SJ-5 (10.143 „Oblik reči X" ka nepostojećoj osnovi – spisak za odluku u `AUDIT/SJ-5-za-odluku.md`)

**NISKO (8):** SEO-2 (sirovi kanonikal `?rec=` – meri se 14 dana, NE 301) · SEO-3 (`http://www.` 2 skoka – Traefik u Coolify-ju, van repoa) · BZ-4 (CSP `*.googletagmanager.com` – prihvaćen rizik, statički sajt bez nonce) · P-2 (`frekvencija.json` bez pretrage – namerno, redosled rima mora biti isti kao na stranama) · A-3 (autofokus zaobilazi skip-link – namerno; skip-link je na Shift+Tab) · PR-2b (na 600 px Enter na reči zatvori karticu, fokus na body; Space ne) · TP-9 (12 lažno zelenih provera – nisu pooštrene) · TP-11 (298 fiksnih pauza – čuvar broja provera jeste dodat, pauze nisu zamenjene)
