...
zahtev. Igru pre objave pokrivaju brze provere u `predeploy.mjs` (sekcija 9: start, odbijanje, priznavanje; sekcija 56:
Reč dana) – bez igranja partija.
...
| Test | pre objave SAMO brze provere u `predeploy.mjs`; `igra-kao-covek.mjs` i `igra-100-partija.mjs` isključivo na zahtev vlasnice (08.09.: „igrica se više ne igra"). |
